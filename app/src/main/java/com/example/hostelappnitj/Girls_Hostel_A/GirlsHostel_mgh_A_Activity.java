...
public class GirlsHostel_mgh_A_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mgh_a_girls_hostel);
        ...
        sharedPrefManager=new SharedPrefManager(GirlsHostel_mgh_A_Activity.this);
        ...
        hostelRules.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(GirlsHostel_mgh_A_Activity.this, Hostel_Rules_Activity.class);
        ...
        messRules.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(GirlsHostel_mgh_A_Activity.this, Mess_Rules.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK|Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
            }
        });
        hostelStaff.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(GirlsHostel_mgh_A_Activity.this, Mega_girls_hostelStaff.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK|Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
            }
        });
        expulsionRules.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(GirlsHostel_mgh_A_Activity.this, ExpulsionFromHostelRules.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK|Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
            }
        });
        hostelRegisteration.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (genderRestriction.equals("male")) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(GirlsHostel_mgh_A_Activity.this);
...
//                dialog box to select floors
                    MaterialAlertDialogBuilder builder = new MaterialAlertDialogBuilder(GirlsHostel_mgh_A_Activity.this);
                    ...
                    builder.setSingleChoiceItems(hostelFloors, 0, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            switch (which) {
                                case 0: // Ground floor
                                    Intent intent0 = new Intent(GirlsHostel_mgh_A_Activity.this, mgh_A_floor_Ground.class);
                                    intent0.putExtra("hostelName", "Girls Hostel A");
                                    startActivity(intent0);
                                    break;
                                case 1: //floor 1
                                    Intent intent1 = new Intent(GirlsHostel_mgh_A_Activity.this, mgh_A_floor_1.class);
                                    intent1.putExtra("hostelName", "Girls Hostel A");
                                    startActivity(intent1);
                                    break;
                                case 2: //floor 2
                                    Intent intent2 = new Intent(GirlsHostel_mgh_A_Activity.this, mgh_A_floor_2.class);
                                    intent2.putExtra("hostelName", "Girls Hostel A");
                                    startActivity(intent2);
                                    break;
                                case 3: //floor 3
                                    Intent intent3 = new Intent(GirlsHostel_mgh_A_Activity.this,mgh_A_floor_3.class);
                                    intent3.putExtra("hostelName", "Girls Hostel A");
                                    startActivity(intent3);
                                    break;
                                case 4: //floor 1
                                    Intent intent4 = new Intent(GirlsHostel_mgh_A_Activity.this, mgh_A_floor_4.class);
                                    intent4.putExtra("hostelName", "Girls Hostel A");
                                    startActivity(intent4);
                                    break;
                                case 5: //floor 2
                                    Intent intent5 = new Intent(GirlsHostel_mgh_A_Activity.this, mgh_A_floor_5.class);
                                    intent5.putExtra("hostelName", "Girls Hostel A");
                                    startActivity(intent5);
                                    break;
                                case 6: //floor 3
                                    Intent intent6 = new Intent(GirlsHostel_mgh_A_Activity.this, mgh_A_floor_6.class);
                                    intent6.putExtra("hostelName", "Girls Hostel A");
                                    startActivity(intent6);
                                    break;
                                case 7: //floor 3
                                    Intent intent7 = new Intent(GirlsHostel_mgh_A_Activity.this, mgh_A_floor_7.class);
                                    intent7.putExtra("hostelName", "Girls Hostel A");
                                    startActivity(intent7);
                                    break;
                                case 8: //floor 3
                                    Intent intent8 = new Intent(GirlsHostel_mgh_A_Activity.this, mgh_A_floor_8.class);
                                    intent8.putExtra("hostelName", "Girls Hostel A");
                                    startActivity(intent8);
                                    break;
                                case 9: //floor 3
                                    Intent intent9 = new Intent(GirlsHostel_mgh_A_Activity.this, mgh_A_floor_9.class);
                                    intent9.putExtra("hostelName", "Girls Hostel A");
                                    startActivity(intent9);
                                    break;
                                case 10: //floor 3
                                    Intent intent10 = new Intent(GirlsHostel_mgh_A_Activity.this, mgh_A_floor_10.class);
                                    intent10.putExtra("hostelName", "Girls Hostel A");
                                    startActivity(intent10);
                                    break;
                                case 11: //floor 3
                                    Intent intent11 = new Intent(GirlsHostel_mgh_A_Activity.this, mgh_A_floor_11.class);
