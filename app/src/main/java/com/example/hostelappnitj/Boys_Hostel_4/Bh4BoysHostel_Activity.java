...
public class Bh4BoysHostel_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bh4_boys_hostel);
        ...
        sharedPrefManager=new SharedPrefManager(Bh4BoysHostel_Activity.this);
        ...
        expulsionFromHostel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Bh4BoysHostel_Activity.this, ExpulsionFromHostelRules.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK|Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
            }
        });
        messRules.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Bh4BoysHostel_Activity.this, Mess_Rules.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK|Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
            }
        });
        ...
        hostelRules.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Bh4BoysHostel_Activity.this, Hostel_Rules_Activity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK|Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
            }
        });
        hostelRegisteration.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (genderRestriction.equals("female")) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(Bh4BoysHostel_Activity.this);
...
//                dialog box to select floors
                                MaterialAlertDialogBuilder builder = new MaterialAlertDialogBuilder(Bh4BoysHostel_Activity.this);
                                ...
                                builder.setSingleChoiceItems(hostelFloors, 0, new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        switch (which) {
                                            case 0: // Ground floor
                                                Intent intent0 = new Intent(Bh4BoysHostel_Activity.this, Bh_4_Floor_Ground.class);
                                                intent0.putExtra("hostelName", "Boys Hostel 4");
                                                startActivity(intent0);
                                                break;
                                            case 1: //floor 1
                                                Intent intent = new Intent(Bh4BoysHostel_Activity.this, Bh_4_Floor_1.class);
                                                intent.putExtra("hostelName", "Boys Hostel 4");
                                                startActivity(intent);
                                                break;
                                            case 2: //floor 2
                                                Intent intent2 = new Intent(Bh4BoysHostel_Activity.this, Bh_4_Floor_2.class);
...
//                                    break;
                ...
                AlertDialog.Builder builder1 = new AlertDialog.Builder(Bh4BoysHostel_Activity.this);
                // on below line we are setting message for our dialog box.
