...
import com.example.hostelappnitj.databinding.ActivityBh7EFloor2Binding;
...
public class Bh_7E_Floor_2 extends AppCompatActivity {
    private ActivityBh7EFloor2Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding= ActivityBh7EFloor2Binding.inflate(getLayoutInflater());
        AppCompatDelegate.setDefaultNightMode(AppCompatDelegate.MODE_NIGHT_NO);  //To make the NIGHT MODE disabled
        setContentView(binding.getRoot());
        this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);

        sharedPrefManager = new SharedPrefManager(Bh_7E_Floor_2.this);
...
//                Toast.makeText(Floor_2_SeatMatrix.this, "Register here", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(Bh_7E_Floor_2.this, RoomConfirmer.class);
...
//                    Toast.makeText(Floor_1_SeatMatrix_A.this, buttonID, Toast.LENGTH_SHORT).show();
                    ...
                    progressDialog1 = new ProgressDialog(Bh_7E_Floor_2.this);
                    ...
                    call.enqueue(new Callback<com.example.hostelappnitj.ModelResponse.studentListModel>() {
                        ...
                        public void onResponse(Call<com.example.hostelappnitj.ModelResponse.studentListModel> call, Response<com.example.hostelappnitj.ModelResponse.studentListModel> response) {
                            ...
                            if (response.isSuccessful()) {
                                if (responseFromAPI.getMessage().equals("no user found")) {
                                    ...
                                    Toast.makeText(Bh_7E_Floor_2.this, "Room is Empty", Toast.LENGTH_SHORT).show();
                                }
                                if (responseFromAPI.getMessage().equals("single user found")) {
                                    Toast.makeText(Bh_7E_Floor_2.this, "single user exist", Toast.LENGTH_SHORT).show();
                                    ...
                                    Intent intent = new Intent(Bh_7E_Floor_2.this, SearchStudent_AdminActivity.class);
                                ...
                                if (responseFromAPI.getMessage().equals("two user found")) {
                                    Toast.makeText(Bh_7E_Floor_2.this, "both user exist", Toast.LENGTH_SHORT).show();
                                    person p1 = responseFromAPI.getPerson1();
                        ...
                        public void onFailure(Call<com.example.hostelappnitj.ModelResponse.studentListModel> call, Throwable t) {
                            Toast.makeText(Bh_7E_Floor_2.this, t.getMessage(), Toast.LENGTH_SHORT).show();
                            progressDialog1.dismiss();
