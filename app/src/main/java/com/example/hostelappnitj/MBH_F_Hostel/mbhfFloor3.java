...
import com.example.hostelappnitj.databinding.ActivityMbhfFloor3Binding;
...
public class mbhfFloor3 extends AppCompatActivity {

    private ActivityMbhfFloor3Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityMbhfFloor3Binding.inflate(getLayoutInflater());
        AppCompatDelegate.setDefaultNightMode(AppCompatDelegate.MODE_NIGHT_NO);  //To make the NIGHT MODE disabled
        setContentView(binding.getRoot());
        this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);

        sharedPrefManager = new SharedPrefManager(mbhfFloor3.this);
...
//        TO PASS THE INTENT TO NEXT REGISTER ACTIVITY
        binding.btnRoomBook3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(mbhfFloor3.this, "Register here", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(mbhfFloor3.this, RoomConfirmer.class);
...
//                    Toast.makeText(Floor_1_SeatMatrix_A.this, buttonID, Toast.LENGTH_SHORT).show();
                    ...
                    progressDialog1 = new ProgressDialog(mbhfFloor3.this);
                    ...
                    call.enqueue(new Callback<com.example.hostelappnitj.ModelResponse.studentListModel>() {
                        ...
                        public void onResponse(Call<com.example.hostelappnitj.ModelResponse.studentListModel> call, Response<com.example.hostelappnitj.ModelResponse.studentListModel> response) {
                            ...
                            if(response.isSuccessful()){
                                if(responseFromAPI.getMessage().equals("no user found")){
                                    ...
                                    Toast.makeText(mbhfFloor3.this, "Room is Empty", Toast.LENGTH_SHORT).show();
                                }
                                if (responseFromAPI.getMessage().equals("single user found")){
                                    Toast.makeText(mbhfFloor3.this, "single user exist", Toast.LENGTH_SHORT).show();
                                    ...
                                    Intent intent = new Intent(mbhfFloor3.this, SearchStudent_AdminActivity.class);
                                ...
                                if (responseFromAPI.getMessage().equals("two user found")){
                                    Toast.makeText(mbhfFloor3.this, "both user exist", Toast.LENGTH_SHORT).show();
                                    person p1 = responseFromAPI.getPerson1();
                        ...
                        public void onFailure(Call<com.example.hostelappnitj.ModelResponse.studentListModel> call, Throwable t) {
                            Toast.makeText(mbhfFloor3.this, t.getMessage(), Toast.LENGTH_SHORT).show();
                            progressDialog1.dismiss();
