...
public class Bh4_AdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hostelList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String hosteName = "Boys Hostel 4";

                Intent intent = new Intent(Bh4_AdminActivity.this,StudentByName.class);
...
//                dialog box to select floors
                MaterialAlertDialogBuilder builder = new MaterialAlertDialogBuilder(Bh4_AdminActivity.this);
                ...
                builder.setSingleChoiceItems(hostelFloors, 0, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        switch (which) {
                            case 0: // Ground floor
                                Intent intent0 = new Intent(Bh4_AdminActivity.this, Bh_4_Floor_Ground.class);
                                intent0.putExtra("hostelName", "Boys Hostel 4");
                                startActivity(intent0);
                                break;
                            case 1: //floor 1
                                Intent intent = new Intent(Bh4_AdminActivity.this, Bh_4_Floor_1.class);
                                intent.putExtra("hostelName", "Boys Hostel 4");
                                startActivity(intent);
                                break;
                            case 2: //floor 2
                                Intent intent2 = new Intent(Bh4_AdminActivity.this, Bh_4_Floor_2.class);
                                intent2.putExtra("hostelName", "Boys Hostel 4");
                                startActivity(intent2);
                                break;
                            case 3: //floor 3
                                Intent intent3 = new Intent(Bh4_AdminActivity.this,  Bh_4_Floor_3.class);
        ...
        btnProccedRoomNumber.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(roomNumber.isEmpty()){
                    ...
                    String hostelName =   "Boys Hostel 4";
                    ...
                    call.enqueue(new Callback<com.example.hostelappnitj.ModelResponse.studentListModel>() {
                        ...
                        public void onResponse(Call<com.example.hostelappnitj.ModelResponse.studentListModel> call, Response<com.example.hostelappnitj.ModelResponse.studentListModel> response) {
                            ...
                            if(response.isSuccessful()){
                                if(responseFromAPI.getMessage().equals("no user found")){
                                    ...
                                    Toast.makeText(Bh4_AdminActivity.this, "Room is Empty", Toast.LENGTH_SHORT).show();
                                }
                                if (responseFromAPI.getMessage().equals("user found")){
                                    Toast.makeText(Bh4_AdminActivity.this, "single user exist", Toast.LENGTH_SHORT).show();
                                    ...
                                    Intent intent = new Intent(Bh4_AdminActivity.this,SearchStudent_AdminActivity.class);
                                ...
                                if (responseFromAPI.getMessage().equals("two user found")){
                                    Toast.makeText(Bh4_AdminActivity.this, "both user exist", Toast.LENGTH_SHORT).show();
                                    person p1 = responseFromAPI.getPerson1();
                        ...
                        public void onFailure(Call<com.example.hostelappnitj.ModelResponse.studentListModel> call, Throwable t) {
                            Toast.makeText(Bh4_AdminActivity.this, t.getMessage(), Toast.LENGTH_SHORT).show();
                            progressDialog.dismiss();
        ...
        btnProccedStudentName.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(studentName.isEmpty()){
                    ...
                    Intent intent = new Intent(Bh4_AdminActivity.this,StudentList_AdminActivity.class);
