...
import com.example.hostelappnitj.Girls_Hostel_B.mgh_B_floor_1;
import com.example.hostelappnitj.Girls_Hostel_B.mgh_B_floor_10;
import com.example.hostelappnitj.Girls_Hostel_B.mgh_B_floor_11;
import com.example.hostelappnitj.Girls_Hostel_B.mgh_B_floor_2;
import com.example.hostelappnitj.Girls_Hostel_B.mgh_B_floor_3;
import com.example.hostelappnitj.Girls_Hostel_B.mgh_B_floor_4;
import com.example.hostelappnitj.Girls_Hostel_B.mgh_B_floor_5;
import com.example.hostelappnitj.Girls_Hostel_B.mgh_B_floor_6;
import com.example.hostelappnitj.Girls_Hostel_B.mgh_B_floor_7;
import com.example.hostelappnitj.Girls_Hostel_B.mgh_B_floor_8;
import com.example.hostelappnitj.Girls_Hostel_B.mgh_B_floor_9;
...
public class girls_B_AdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_girls_b_admin);
        ...
        hostelList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String hosteName = "Girls Hostel B";

                Intent intent = new Intent(girls_B_AdminActivity.this,StudentByName.class);
...
//                dialog box to select floors
                MaterialAlertDialogBuilder builder = new MaterialAlertDialogBuilder(girls_B_AdminActivity.this);
                ...
                builder.setSingleChoiceItems(hostelFloors, 0, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        switch (which){
                            case 0: //floor 1
                                Intent intent1 = new Intent(girls_B_AdminActivity.this, mgh_B_floor_1.class);
                                intent1.putExtra("hostelName", "Girls Hostel B");
                                startActivity(intent1);
                                break;
                            case 1: //floor 2
                                Intent intent2 = new Intent(girls_B_AdminActivity.this, mgh_B_floor_2.class);
                                intent2.putExtra("hostelName", "Girls Hostel B");
                                startActivity(intent2);
                                break;
                            case 2: //floor 3
                                Intent intent3 = new Intent(girls_B_AdminActivity.this, mgh_B_floor_3.class);
                                intent3.putExtra("hostelName", "Girls Hostel B");
                                startActivity(intent3);
                                break;
                            case 3: //floor 1
                                Intent intent4 = new Intent(girls_B_AdminActivity.this, mgh_B_floor_4.class);
                                intent4.putExtra("hostelName", "Girls Hostel B");
                                startActivity(intent4);
                                break;
                            case 4: //floor 2
                                Intent intent5 = new Intent(girls_B_AdminActivity.this, mgh_B_floor_5.class);
                                intent5.putExtra("hostelName", "Girls Hostel B");
                                startActivity(intent5);
                                break;
                            case 5: //floor 3
                                Intent intent6 = new Intent(girls_B_AdminActivity.this, mgh_B_floor_6.class);
                                intent6.putExtra("hostelName", "Girls Hostel B");
                                startActivity(intent6);
                                break;
                            case 6: //floor 3
                                Intent intent7 = new Intent(girls_B_AdminActivity.this, mgh_B_floor_7.class);
                                intent7.putExtra("hostelName", "Girls Hostel B");
                                startActivity(intent7);
                                break;
                            case 7: //floor 3
                                Intent intent8 = new Intent(girls_B_AdminActivity.this, mgh_B_floor_8.class);
                                intent8.putExtra("hostelName", "Girls Hostel B");
                                startActivity(intent8);
                                break;
                            case 8: //floor 3
                                Intent intent9 = new Intent(girls_B_AdminActivity.this, mgh_B_floor_9.class);
                                intent9.putExtra("hostelName", "Girls Hostel B");
                                startActivity(intent9);
                                break;
                            case 9: //floor 3
                                Intent intent10 = new Intent(girls_B_AdminActivity.this, mgh_B_floor_10.class);
                                intent10.putExtra("hostelName", "Girls Hostel B");
                                startActivity(intent10);
                                break;
                            case 10: //floor 3
                                Intent intent11 = new Intent(girls_B_AdminActivity.this, mgh_B_floor_11.class);
                ...
                if(roomNumber.isEmpty()){
                    ...
                    call.enqueue(new Callback<com.example.hostelappnitj.ModelResponse.studentListModel>() {
                        ...
                        public void onResponse(Call<com.example.hostelappnitj.ModelResponse.studentListModel> call, Response<com.example.hostelappnitj.ModelResponse.studentListModel> response) {
                            ...
                            if(response.isSuccessful()){
                                if(responseFromAPI.getMessage().equals("no user found")){
                                    ...
                                    Toast.makeText(girls_B_AdminActivity.this, "Room is Empty", Toast.LENGTH_SHORT).show();
                                }
                                if (responseFromAPI.getMessage().equals("single user found")){
                                    Toast.makeText(girls_B_AdminActivity.this, "single user exist", Toast.LENGTH_SHORT).show();
                                    ...
                                    Intent intent = new Intent(girls_B_AdminActivity.this,SearchStudent_AdminActivity.class);
                                ...
                                if (responseFromAPI.getMessage().equals("two user found")){
                                    Toast.makeText(girls_B_AdminActivity.this, "both user exist", Toast.LENGTH_SHORT).show();
                                    person p1 = responseFromAPI.getPerson1();
                        ...
                        public void onFailure(Call<com.example.hostelappnitj.ModelResponse.studentListModel> call, Throwable t) {
                            Toast.makeText(girls_B_AdminActivity.this, t.getMessage(), Toast.LENGTH_SHORT).show();
                            progressDialog.dismiss();
        ...
        btnProccedStudentName.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(studentName.isEmpty()){
                    ...
                    Intent intent = new Intent(girls_B_AdminActivity.this,StudentList_AdminActivity.class);
                    intent.putExtra("studentName",studentName);
                    intent.putExtra("hostelName","Girls Hostel B");
                    etStudentName.setText("");
                    startActivity(intent);
                }
            }
