...
import com.example.hostelappnitj.databinding.ActivityForgetOtpactivityBinding;
...
public class ForgetOTPActivity extends AppCompatActivity {
    ActivityForgetOtpactivityBinding binding;
    String email ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityForgetOtpactivityBinding.inflate(getLayoutInflater());
        ...
        binding.SubmitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                progressDialog = new ProgressDialog(ForgetOTPActivity.this);
...
//to get the string numbers enter by user
                    ...
                    if(code_by_user==null){
                        Toast.makeText(ForgetOTPActivity.this, "Please Enter OTP", Toast.LENGTH_SHORT).show();
                        progressDialog.dismiss();
                    }
//API integrate
                    OTP_model model = new OTP_model(email , code_by_user);
                    Call<OTP_model> call = RetrofitClient.getInstance().getApi().veriftyOTPForgetPass(model);
...
//                            Toast.makeText(OTPActivity.this, "Entered response", Toast.LENGTH_SHORT).show();
                            ...
                            if(response.isSuccessful()){
                                if(responseFromAPI.getMessage().equals("User Already Exist")){
                                    Toast.makeText(ForgetOTPActivity.this, "User Already Exist", Toast.LENGTH_SHORT).show();
                                    progressDialog.dismiss();

                                }
                                else if (responseFromAPI.getMessage().equals("Code expired")){
                                    progressDialog.dismiss();
                                    Toast.makeText(ForgetOTPActivity.this, "Code Expires..", Toast.LENGTH_SHORT).show();
                                    ...
                                    progressDialog.dismiss();
                                    Toast.makeText(ForgetOTPActivity.this, "Invalid Code..\nResend Code", Toast.LENGTH_SHORT).show();
                                    binding.otpView1.setText("");
                                    binding.otpView2.setText("");
                                    binding.otpView3.setText("");
                                    binding.otpView4.setText("");
                                    ...
                                    progressDialog.dismiss();
                                    Intent intent1 = new Intent(ForgetOTPActivity.this,changePasswordActivity.class);
                                ...
                                progressDialog.dismiss();
                                Toast.makeText(ForgetOTPActivity.this, "Something went wrong..", Toast.LENGTH_SHORT).show();
                            }
                        }
                        ...
                        public void onFailure(Call<OTP_model> call, Throwable t) {
                            progressDialog.dismiss();
                            Toast.makeText(ForgetOTPActivity.this, t.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
                    ...
                    progressDialog.dismiss();
                    Toast.makeText(ForgetOTPActivity.this, "Please Enter Complete OTP", Toast.LENGTH_SHORT).show();
