...
import com.example.hostelappnitj.databinding.ActivityFloor6SeatMatrixBinding;
import com.example.hostelappnitj.databinding.ActivityMghSeatMatrixFloor6Binding;
...
public class MghSeatMatrixFloor6 extends AppCompatActivity {

    private ActivityMghSeatMatrixFloor6Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding =  ActivityMghSeatMatrixFloor6Binding.inflate(getLayoutInflater());
        View view = binding.getRoot();
        AppCompatDelegate.setDefaultNightMode(AppCompatDelegate.MODE_NIGHT_NO);  //To make the NIGHT MODE disabled
        setContentView(view);
        this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);

        sharedPrefManager = new SharedPrefManager(MghSeatMatrixFloor6.this);
...
//        TO PASS THE INTENT TO NEXT REGISTER ACTIVITY
        binding.btnRoomBook3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(MghSeatMatrixFloor6.this, "Register here", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(MghSeatMatrixFloor6.this, RoomConfirmer.class);
...
//                    Toast.makeText(Floor_1_SeatMatrix_A.this, buttonID, Toast.LENGTH_SHORT).show();
                    ...
                    progressDialog1 = new ProgressDialog(MghSeatMatrixFloor6.this);
                    ...
                    call.enqueue(new Callback<com.example.hostelappnitj.ModelResponse.studentListModel>() {
                        ...
                        public void onResponse(Call<com.example.hostelappnitj.ModelResponse.studentListModel> call, Response<com.example.hostelappnitj.ModelResponse.studentListModel> response) {
                            ...
                            if (response.isSuccessful()) {
                                if (responseFromAPI.getMessage().equals("no user found")) {
                                    ...
                                    Toast.makeText(MghSeatMatrixFloor6.this, "Room is Empty", Toast.LENGTH_SHORT).show();
                                }
                                if (responseFromAPI.getMessage().equals("single user found")) {
                                    Toast.makeText(MghSeatMatrixFloor6.this, "single user exist", Toast.LENGTH_SHORT).show();
                                    ...
                                    Intent intent = new Intent(MghSeatMatrixFloor6.this, SearchStudent_AdminActivity.class);
                                ...
                                if (responseFromAPI.getMessage().equals("two user found")) {
                                    Toast.makeText(MghSeatMatrixFloor6.this, "both user exist", Toast.LENGTH_SHORT).show();
                                    person p1 = responseFromAPI.getPerson1();
                        ...
                        public void onFailure(Call<com.example.hostelappnitj.ModelResponse.studentListModel> call, Throwable t) {
                            Toast.makeText(MghSeatMatrixFloor6.this, t.getMessage(), Toast.LENGTH_SHORT).show();
                            progressDialog1.dismiss();
