...
//        TO PASS THE INTENT TO NEXT REGISTER ACTIVITY
        binding.btnRoomBook3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(mgh_seatmatrix_ground.this, RegisterationActivity.class);
        ...
        call.enqueue(new Callback<HostelRegisterationResponse>() {
            ...
            public void onResponse(Call<HostelRegisterationResponse> call, Response<HostelRegisterationResponse> response) {
                ...
                if(response.isSuccessful()){
                    Toast.makeText(getApplicationContext(), "Hostels Updated", Toast.LENGTH_SHORT).show();
...
//                                    both ARE present roomNumberFullyFilled.add(room);
...
//                            student 1 is present only partially filled roomNumber.add(room);
...
//                    binding.display.setText("total "+n);                     hosteltxt.setText("names : "+usernames);

                }else{
                    Toast.makeText(mgh_seatmatrix_ground.this, "Something went Wrong..", Toast.LENGTH_SHORT).show();
                }
            }
