...
//                dialog box to select floors
                ...
                builder.setSingleChoiceItems(hostelFloors, 0, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        switch (which){
                            case 0 : // Ground floor
                                Intent intent0 = new Intent(MegaGirlsActivity.this, SeatmatrixMBHBoys.class);
                                intent0.putExtra("hostelName","Mega Boys Hostel B");
                                startActivity(intent0);
                                break;
                            case 1 : //floor 1
                                Intent intent = new Intent(MegaGirlsActivity.this, SeatmatrixMBHBoys.class);
                                intent.putExtra("hostelName","Mega Boys Hostel B");
                                startActivity(intent);
                                break;
                            case 2 : //floor 2
                                Intent intent2 = new Intent(MegaGirlsActivity.this, SeatmatrixMBHBoys.class);
                                intent2.putExtra("hostelName","Mega Boys Hostel B");
                                startActivity(intent2);
                                break;
                            case 3 : //floor 3
                                Intent intent3 = new Intent(MegaGirlsActivity.this, SeatmatrixMBHBoys.class);
                                intent3.putExtra("hostelName","Mega Boys Hostel B");
                                startActivity(intent3);
                                break;
                            case 4 : //floor 1
                                Intent intent4 = new Intent(MegaGirlsActivity.this, SeatmatrixMBHBoys.class);
                                intent4.putExtra("hostelName","Mega Boys Hostel B");
                                startActivity(intent4);
                                break;
                            case 5 : //floor 2
                                Intent intent5 = new Intent(MegaGirlsActivity.this, SeatmatrixMBHBoys.class);
                                intent5.putExtra("hostelName","Mega Boys Hostel B");
                                startActivity(intent5);
                                break;
                            case 6 : //floor 3
                                Intent intent6 = new Intent(MegaGirlsActivity.this, SeatmatrixMBHBoys.class);
